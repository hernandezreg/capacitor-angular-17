...
public class AkamaiBmpCordovaPlugin extends CordovaPlugin {
    ...
    private final static String INITIALIZE_SDK = "initializeSDK";
    private final static String INITIALIZE_SDK_POW = "initializeSDKWithPow";

    private final static String INIT_SDK_CALLBACK = "initSDKCallback";
    ...
    public boolean execute(String action, JSONArray argcoms, final CallbackContext callbackContext)
        ...
        if (SET_LOG_LEVEL.equals(action)) {
            ...
            this.cordova.getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(baseUrl.equals("null")){
                        ...
                        CYFMonitor.initializeSDK(app, baseUrl);
                    }
                    com.cyberfend.cyfsecurity.CYFMonitor.setActivityVisible(true);
                }
            });
            ...
            return true;
        }else if (INIT_SDK_CALLBACK.equals(action)) {
            CYFMonitor.setSDKInitCallBack(new CYFMonitor.CYFSDKInitCallback() {
                @Override
                ...
                @Override
                public void onSDKInitFailure(String message) {
                    Log.d(TAG, "onSDKInitFailure");
                    JSONObject response = prepareResponseObject(-1, null);
                    callbackContext.success(response);
                }
            });
            return true;
        } else if(INITIALIZE_SDK_POW.equals(action)) {
            String baseUrl = argcoms.getString(0);
            ...
            this.cordova.getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(baseUrl.equals("null")){
                        ...
                        CYFMonitor.initializeSDKWithPow(app, baseUrl);
                    }
                    com.cyberfend.cyfsecurity.CYFMonitor.setActivityVisible(true);
                }
            });
